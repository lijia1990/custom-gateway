...
public class CustomRedisScript<T> implements RedisScript<T>, InitializingBean {
     ...
     * @since 2.0
     */
    public CustomRedisScript(String script) {
        this(script, null);
    }
     ...
     */
    public CustomRedisScript(String script, @Nullable Class<T> resultType) {
